#!/usr/bin/env python3
"""
Register MCP Gesture Hub Agent to Agentverse
"""
import os
...
print("=" * 60)
print("🚀 Registering MCP Gesture Hub Agent to Agentverse")
print("=" * 60)
print(f"Agent Name: gesture-hub")
...
try:
    ...
    print("✅ MCP Gesture Hub Agent registered successfully!")
    print()
    print("Next steps:")
    print("1. Go to https://agentverse.ai/agents")
    print("2. You should see 'gesture-hub' in your agents list")
